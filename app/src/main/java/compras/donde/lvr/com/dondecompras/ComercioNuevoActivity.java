 ...
 */
public class ComercioNuevoActivity extends AppCompatActivity {
    JSONArray jsonarray;
    ListView listview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comercio_nuevo);
    ...
    private class DownloadJSON extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(ComercioNuevoActivity.this);
        ...
        protected void onPostExecute(Void result) {
            ...
            clase
                    .setAdapter(new ArrayAdapter<String>(ComercioNuevoActivity.this,
